...
import ar.edu.um.final.tarjeta.config.audit.AuditEventConverter;
import ar.edu.um.final.tarjeta.domain.PersistentAuditEvent;
...
import static ar.edu.um.final.tarjeta.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
