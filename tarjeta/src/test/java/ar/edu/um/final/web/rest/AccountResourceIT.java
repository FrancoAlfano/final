package ar.edu.um.final.web.rest;

import ar.edu.um.final.TarjetaApp;
import ar.edu.um.final.config.Constants;
import ar.edu.um.final.domain.Authority;
import ar.edu.um.final.domain.User;
import ar.edu.um.final.repository.AuthorityRepository;
import ar.edu.um.final.repository.UserRepository;
import ar.edu.um.final.security.AuthoritiesConstants;
import ar.edu.um.final.service.MailService;
import ar.edu.um.final.service.UserService;
import ar.edu.um.final.service.dto.PasswordChangeDTO;
import ar.edu.um.final.service.dto.UserDTO;
import ar.edu.um.final.web.rest.errors.ExceptionTranslator;
import ar.edu.um.final.web.rest.vm.KeyAndPasswordVM;
import ar.edu.um.final.web.rest.vm.ManagedUserVM;
