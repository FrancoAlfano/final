...
public class ClienteResourceIT {
    ...
    public void createCliente() throws Exception {
        ...
        assertThat(testCliente.getCliente_id()).isEqualTo(DEFAULT_CLIENTE_ID);
    ...
    @Test
    @Transactional
    public void checkCliente_idIsRequired() throws Exception {
    ...
    public void getAllClientes() throws Exception {
        ...
        restClienteMockMvc.perform(get("/api/clientes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].cliente_id").value(hasItem(DEFAULT_CLIENTE_ID.intValue())))
    ...
    public void getCliente() throws Exception {
        ...
        restClienteMockMvc.perform(get("/api/clientes/{id}", cliente.getId()))
            ...
            .andExpect(jsonPath("$.cliente_id").value(DEFAULT_CLIENTE_ID.intValue()))
    ...
    public void updateCliente() throws Exception {
        ...
        Cliente testCliente = clienteList.get(clienteList.size() - 1);
        assertThat(testCliente.getCliente_id()).isEqualTo(UPDATED_CLIENTE_ID);
